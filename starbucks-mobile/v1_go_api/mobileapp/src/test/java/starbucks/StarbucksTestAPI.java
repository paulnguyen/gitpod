...
class StarbucksTestAPI {

	private String apiurl = "" ;
    private String apikey = "" ;
    private String register = "" ;

	public StarbucksTestAPI() {
	...
	class Order {
			...
			public String toString() {
					return  "Size: [" + size + "] Drink: [" + drink + "] Milk: [" + milk + "] Total: [" + getFormatedTotal() + "]"  ;
			}
	}

	public Order newOrder(String regid) throws Exception {
		...
		*/
	    ...
	    try {
	        ...
	        System.err.println( json.toString() ) ;
					...
					order.total = 0.00f ;
					order.drink = json.getString( "Drink" ) ;
					order.milk = json.getString( "Milk" ) ;
					order.size = json.getString( "Size" ) ;
					order.total = json.getDouble( "Total" ) ;
					if ( order.total == 0.0 )
							throw new Exception("API Call Failed!") ;
					return order ;
	    } catch (Exception e) {
	...
	public Order getOrder( String regid ) throws Exception {
        try {
